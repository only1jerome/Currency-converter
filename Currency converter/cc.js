...
const API_KEY = "4ee932af9c101b0ac80bced461cc4ee9"

// const dataURL = "http://api.exchangeratesapi.io/v1/latest?access_key=4ee932af9c101b0ac80bced461cc4ee9"
...
currenciesList.addEventListener("focusout", function(event){
...
currenciesList.addEventListener("keydown", function(event){
    ...
    for(let i=0; i<currencies.length; i++) {
      addCurrencyList.insertAdjacentHTML(
        ...
        `<li data-currency=${currencies[i].abbreviation}>
          <img src=${currencies[i].flagURL} class="flag"><span class="symb">${currencies[i].abbreviation}</span> <span>${currencies[i].name}</span>
        </li>`
      )
    }
  }
